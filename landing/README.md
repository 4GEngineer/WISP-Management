...
- **Content:** Single-page static HTML/CSS (index.html, 404.html, landing.css, logo.svg). Messaging centers **WISP Management** + **Bandwidth Test Manager** and how they fit together for operators (not generic “AI build” framing).
